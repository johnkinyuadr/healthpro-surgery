  ...
  return (
    <>
      ...
      <section className="hero">
        ...
        <p className="p">
          Vascular &amp; Laparoscopic Surgery in Mombasa, Kenya. Patient-centered, evidence-based
          surgical care with a focus on safety, clear communication, and excellent outcomes.
        </p>

        {/* Primary CTA + Response Time Promise */}
        <div
          className="card"
          style={{
            marginTop: 18,
        ...
        >
          ...
          <p style={{ marginTop: 8, marginBottom: 10, opacity: 0.9 }}>
            Upload your reports and get a specialist review.{" "}
          ...
          >
            ...
            >
              <strong>Fees:</strong> KSh 2,000 initial review • KSh 3,000 in-person (if needed)
            </div>
          </div>
